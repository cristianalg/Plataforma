...
include_once("menu_Pagina_Inicial.php");
 ...
 $query ="SELECT * FROM sistema_operativo ORDER BY idSistema_Operativo DESC";  
                ...
                <table id="tecnico_data" class="table table-striped table-bordered">  
				  ...
				  <?php 
					while($linhas = mysql_fetch_array($resultado)){
						echo "<tr>";
							echo "<td>".$linhas['idSistema_Operativo']."</td>";
							echo "<td>".$linhas['Nome_Sistema_Operativo']."</td>";
							echo "<td>".$linhas['Observacao_Sistema_Operativo']."</td>";
							?>
