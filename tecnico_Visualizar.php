	...
	<div class="page-header">
	 ...
	 <div class="row">
		<div class="pull-right">
			...
			<a href="#" onclick="javascript: if (confirm('Deseja remover este registo?'))location.href='tecnico_Eliminar.php?id=<?php echo $resultado['idTecnico']; ?>'"><img src='imagens/edit_delete.png' width='30px'></a>			
		</div>
	</div> 
